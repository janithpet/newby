...
from new import logger
from new.storage import Storage
from new.templates import TEMPLATES
from new.templates import TemplateType
from new.utilities import retrieve
...
def main() -> None:
    ...
    if language != "python":
        logger.error(
            f"Please enter a subcommand after `new` with one of the following: {LANGUAGES.keys()}"
        )
        exit(1)
